...
const categories = [
  {
    ...
    products: [
      ...
      { name: "LIMICA PLUS Tablets", composition: "Nimesulide 100mg + Paracetamol IP 325mg", pack: "10x10 alu/alu", mrp: "450.00", ptr: "₹175.00" },
      { name: " XARODOL-P Tablets", composition: "Aceclofenac 100mg + Paracetamol 325 mg", pack: "10x10 alu/alu", mrp: "₹440.00", ptr: "₹ " },
      { name: "XARODOL-SP Tablets", composition: "Aceclofenac 100mg + Paracetamol 325 mg + Serratiopeptidase 15mg", pack: "10x10 Alu-Alu", mrp: "₹101.00", ptr: "₹.00" },
      { name: "YOGAPAN-DSR Capsules", composition: "Pantoprazole 40mg+ Domperidone 30mg S.R", pack: "10x10 alu/alu", mrp: "₹95.00", ptr: "₹.00" },
      { name: "XARODOL-SPAS Tablets", composition: "Mefenamic acid 250mg + Dicyclomine 20mg", pack: "10x10 Blister", mrp: "₹55.00", ptr: "₹" },
      { name: "XAROLET Tablets", composition: "Levocetirizine 5mg ", pack: "10x10 alu/alu", mrp: "₹55.00", ptr: "₹" },
      { name: "YOGAPAN 40mg Tablets", composition: "Pantoprazole Sodium IP 40mg", pack: "10x10 Alu-Alu", mrp: "₹75.00", ptr: "₹" },
    ],
  },
  {
    id: "syrups",
